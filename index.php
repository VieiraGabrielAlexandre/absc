                        ...
                        <div class="tm-flex">
                            <div class="tm-contact-left-half tm-gray-bg">
                                <div class="tm-contact-inner-pad">
                                    ...
                                    <form action="envia_fale.php" method="post" class="contact-form">
                                        ...
                                        <div class="form-group">
                                            <textarea id="contact_message" name="mensagem" class="form-control" rows="9" placeholder="Mensagem para nós" required></textarea>
                                        </div>
