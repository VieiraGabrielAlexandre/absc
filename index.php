                ...
                <div class="tm-main-content">
                    ...
                    <div class="tm-content-box tm-content-box-home">                        
                        ...
                        <div class="tm-welcome-boxes-container">
                            <div class="tm-welcome-box">
                                ...
                                <a href="http://abracesuacausa.azurewebsites.net/paginadedoacao.php" class="tm-welcome-link tm-button">Saiba Mais</a>
                            </div>
                            <div class="tm-welcome-box">
                                <div class="tm-welcome-text">
					...
					<div id="Cadastrese" class="tm-content-box">
                        <div class="tm-box-pad tm-bordered-box">
                            ...
                            <a href="http://abracesuacausa.azurewebsites.net/efetuarcadastro.php" class="tm-button tm-button-normal">Clique aqui para se cadastrar</a>
                        </div>
					</div>
                    <div id="TenhoCadastro" class="tm-content-box">
                        <div class="tm-box-pad tm-bordered-box">
							...
							<p> <p>
                            <a href="http://abracesuacausa.azurewebsites.net/login.php" class="tm-button tm-button-normal">Efetuar Login</a>
                        </div>
                        <div class="tm-flex">
