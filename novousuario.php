            ...
            <div id="Campanhas" class="tm-content-box">                        
                       <div class="tm-services-img-container">
                        ...
                        <div class="tm-box-pad tm-services-description-container">
                            <h2 class="tm-section-title">Parabéns por fazer parte ...</h2>
                            <p class="tm-section-description">É um prazer enorme ter você lutando conosco por uma ou mais causas que acha justo.</p>
                            <p class="tm-section-description">Agora temos a missão de fazer a diferença, todo os campos em nosso site é bem intuitivo. Porém ...</p>
                            <p>... Duvidas são normais, qualquer duvida nos contato por e-mail. Agora para seguir para a sua pagina inicial.</p>
                            <p>Basta clicar no botão abaixo e efetuar o login com o seu e-mail cadastrado.</p>
							<li class="tm-nav-item"><a href="login.php" class="tm-nav-item-link tm-button">
                                <i class="fa fa-envelope-o tm-nav-fa"></i>Login</a>
                            </li>
                        </div>       
