...
<section id="welcome" class="tm-content-box tm-banner margin-b-10">
	...
	<section>
    	 ...
    	 <div class="formulario">  
            ...
            <form action="inserircadastrojuridica.php" method="post" id="validate">                  
                <label>Todos os campos deste formulario são obrigaórios.</label>
                <br>
                <br>
                <br>
                <br>
                ...
                <input name="classcliente" type="hidden" value="2">
                ...
                <label>Senha</label>
                <input type="password" name="senha" class="p">
                <input type="submit" value="Enviar">
                <input type="submit" value="Pessoa Fisica" onclick="location. href= 'efetuarcadastro.php' "> 
