...
<html lang="pt-br">
    ...
    <body>
		...
		<h1 class="my-4">Bem vindo,</h1>
			...
			<h1><?php
					        session_start();
                            echo "Adiministrador, ". $_SESSION['usuarioNome']; 
				        ?>
				        <br></h1>
        </div>
         ...
         <div class="row">
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
						<center><img src="img/historico1.png"> </center>
                            <center><a href="noticia1.html">Visualizar Doações</a></center>
                        </h4>
                        <p class="card-text"></p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
						<center><img src="img/21.png"> </center>
                            <center><a href="noticia1.html">Instituições</a></center>
                        </h4>
                        <p class="card-text"></p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
						<center><img src="img/dados1.png"> </center>
                           <center><a href="alterarcadastro.html">Alterar Cadastro</a></center>
                            </h4>
                            <p class="card-text"></p>
                        </div>
                    </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
						<center><img src="img/dados1.png"> </center>
                           <center><a href="alterarcadastro.html">Administrar usuários</a></center>
                            </h4>
                            <p class="card-text"></p>
                        </div>
                    </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
						<center><img src="img/campanha2.png"> </center>
                           <center><a href="alterarcampanha.html">Alterar Campanhas</a></center>
                            </h4>
                            <p class="card-text"></p>
                        </div>
                    </div>
