         ...
         <div class="row">
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
						<center><img src="img/cartao.png"> </center>
                            <center><a href="Cartoes.html">Meus cartões</a></center>
                        </h4>
                        <p class="card-text"></p>
                    </div>
                </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
						...
						<center><img src="img/dados1.png"> </center>
                           <center><a href="noticia1.html">Meus Dados</a></center>
                            </h4>
                            <p class="card-text"></p>
                        </div>
                    </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
						...
						<center><img src="img/campanha2.png"> </center>
                           <center><a href="noticia1.html">Campanhas</a></center>
                            </h4>
                            <p class="card-text"></p>
                        </div>
                    </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
						...
						<center><img src="img/historico1.png"> </center>
                            <center><a href="noticia1.html">Historico de Doações</a></center>
                            </h4>
                            <p class="card-text"></p>
                        </div>
                    </div>
